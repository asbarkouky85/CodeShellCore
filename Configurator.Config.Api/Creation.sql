...
GO
/****** Object:  UserDefinedFunction [dbo].[GenerateId]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[GetCount]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[GetPath]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Clients]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Controls]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[ControlValidators]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DomainEntities]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[DomainEntityCollections]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[DomainEntityProperties]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Domains]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[EntityCollectionConditions]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[NavigationGroups]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NavigationPages]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PageCategories]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[PageControls]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PageControlValidators]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Pages]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[ResourceActions]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Resources]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TenantApps]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Tenants]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Users]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Validators]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[AddAuditingColumns]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[ChangeAccessibilty]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[DeleteTemplate]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SetCollectionId]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SyncDBs]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SyncTenants]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	INSERT INTO TenantDomains (Id,DomainId,TenantId,CreatedOn,UpdatedOn)
	SELECT 
		CONVERT(bigint,CONCAT(@targetTenant,DomainId,'0')),
		DomainId,
		@targetTenant,
		GETDATE(),
		GETDATE()
	...
	SELECT 
		...
		,(
			SELECT top 1 x.Id
				FROM TenantDomains x
				WHERE 
					x.DomainId=TDs.DomainId AND
					x.TenantId=@targetTenant
		)
		,[Apps]
		,[AppearsInNavigation]
		,[HasRoute]
	...
	FROM 
		dbo.Pages Ps
		join dbo.TenantDomains TDs on TDs.Id=Ps.TenantDomainId
		WHERE TenantDomainId IN (
			SELECT Id 
			FROM dbo.TenantDomains
			WHERE TenantId=@sourceTenant
		) AND Ps.ViewPath NOT IN (
			SELECT Pages.ViewPath 
			FROM Pages
				join dbo.TenantDomains on TenantDomains.Id=Pages.TenantDomainId
			WHERE TenantDomains.TenantId=@targetTenant
		);
...
-----------------------------------------------------------------------------------------------
	...
	FROM Pages
		join (
			...
			tx.ViewPath=Pages.ViewPath
		WHERE Pages.TenantDomainId IN (
			SELECT Id
			FROM TenantDomains
			WHERE TenantId=@targetTenant
		) AND
		(Pages.Presistant <> 1 OR Pages.Presistant IS NULL);
...
-----------------------------------------------------------------------------------------------
	...
	INSERT INTO [dbo].[PageControls]
		...
		FROM PageControls
			...
			join TenantDomains on TenantDomains.Id=srcPages.TenantDomainId
		WHERE 
			TenantDomains.TenantId=@sourceTenant AND
			NOT EXISTS (
				SELECT *
				FROM PageControls tarControls
					join Pages tarPages on tarPages.Id=tarControls.PageId
					join TenantDomains tarDoms on tarDoms.Id=tarPages.TenantDomainId
				WHERE 
					tarControls.ControlId=PageControls.ControlId AND
					tarPages.ViewPath=srcPages.ViewPath AND
					tarDoms.TenantId=@targetTenant
			);
		...
		FROM PageControls
			...
			join (
				...
				FROM PageControls
					...
					join TenantDomains on TenantDomains.Id=Pages.TenantDomainId
				WHERE
					(Accessability!=2 OR PageControls.SourceCollectionId is not null) AND
					TenantId=@sourceTenant
			) as Existing on 
				Pages.ViewPath=Existing.ViewPath AND
				Controls.IdentIFier=Existing.IdentIFier --AND
				--PageControls.UpdatedOn < Existing.UpdatedOn
		WHERE 
			TenantDomains.TenantId=@targetTenant;
...
GO
/****** Object:  Trigger [dbo].[Domains_Chain_TR]    Script Date: 10/11/2019 9:01:17 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
