...
namespace CodeShellCore.Text.Globalization
{
    public class ToWord
    {
        ...
        //private static string[] arabicOnes =
        //   new string[] {
        //    String.Empty, "الواحد", "الثاني", "الثالث", "الرابع", "الخامس", "السادس", "السابع", "الثامن", "التاسع",
        //    "العاشر", "الحادي عشر", "الثاني عشر", "الثالث عشر", "الرابع عشر", "الخامس عشر", "السادس عشر", "السابع عشر", "الثامن عشر", "التاسع"
        //};
        ...
        //    new string[] {
        //    "", "المائة", "المئتان", "الثلاثمائة", "الأربعمائة", "الخمسمائة", "الستمائة", "السبعمائة", "الثمانمائة","التسعمائة"
        //};
                ...
                { // if we are processing under 20 numbers
                    ...
                    { // This is special case for number 2 when it comes alone in the group
                        if (_intergerValue == 2000 || _intergerValue == 2000000 || _intergerValue == 2000000000 || _intergerValue == 2000000000000 || _intergerValue == 2000000000000000 || _intergerValue == 2000000000000000000)
                            ...
                            retVal = String.Format("{0}", arabicTwos[groupLevel]);//  في حالة الأفراد
                    }
                    else
                    { // General case
