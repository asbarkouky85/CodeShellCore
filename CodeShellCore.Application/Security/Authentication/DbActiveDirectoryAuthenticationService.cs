...
namespace CodeShellCore.Security.Authentication.Internal
{
    ...
    public class DbActiveDirectoryAuthenticationService : ServiceBase, IAuthenticationService
    {
        //bool _securityUnitChecked = false;
        protected ISecurityUnit _securityUnit;

        public DbActiveDirectoryAuthenticationService(ISecurityUnit unit)
        {
            _securityUnit = unit;
        }
