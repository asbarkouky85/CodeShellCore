...
VersionSetter -p CodeShellCore 2.0.10
VersionSetter -p CodeShellCore.Caching 2.0.10
VersionSetter -p CodeShellCore.MQ 2.0.10
...
VersionSetter -p Asga.Auth 2.0.10
VersionSetter -p Asga.Web 2.0.10
