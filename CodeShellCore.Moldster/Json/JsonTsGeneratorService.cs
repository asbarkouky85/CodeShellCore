...
namespace CodeShellCore.Moldster.Json
{
    public class JsonTsGeneratorService : ScriptGenerationService, IScriptGenerationService
    {
        ...
        public JsonTsGeneratorService(
            ...
            PathProvider paths) : base(wt, mold, paths, enums)
        {
            _data = data;
        }
        ...
        public override void GenerateBaseComponent(string viewPath)
        {
            ...
            using (var s = SW.Measure())
            {
                ...
                Console.Write("Writing Template " + conf.Template + "Base.ts...\t\t");
        ...
        public override void GenerateModuleDefinition(string moduleId, bool lazy)
        {
            ...
            using (var x = SW.Measure())
            {
                ...
                Console.Write("Writing " + moduleName + ".ts...\t\t");
        ...
        public override void GenerateComponent(string moduleName, string domain, string viewPath)
        {
            PageConfig p = _data.GetPageConfig(moduleName, viewPath);
            using (var x = SW.Measure())
            {
        ...
        internal void WriteRoutesLazy(NgModule mod)
        {
            using (var x = SW.Measure())
            {
                ...
                Console.Write("Writing " + builderName + ".ts...\t\t");
