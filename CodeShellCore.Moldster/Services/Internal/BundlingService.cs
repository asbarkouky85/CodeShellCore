...
namespace CodeShellCore.Moldster.Services.Internal
{
    public class BundlingService : ConsoleService, IBundlingService
    {
        ...
        void AddToBaseFolder(string name, string content, bool checkForFolder = false)
        {
        ...
        void AddToUI(string name, string content)
        {
        ...
        void BaseModuleFiles()
        {
            ...
            AddToBaseFolder(_paths.CoreAppName + "BaseModule.ts", content, true);
            AddToBaseFolder("AppComponentBase.ts", Properties.Resources.AppComponentBase_ts, true);
            AddToBaseFolder("ServerConfig.ts", Properties.Resources.ServerConfig_ts);

            AddToBaseFolder("Main/Login.html", Properties.Resources.Login_html, true);
            AddToBaseFolder("Main/Login.ts", Properties.Resources.Login_ts);
            AddToBaseFolder("Main/topBar.html", Properties.Resources.topBar_html);
            AddToBaseFolder("Main/topBar.ts", Properties.Resources.topBar_ts);
            AddToBaseFolder("Main/navigationSideBar.html", Properties.Resources.navigationSideBar_html);
            AddToBaseFolder("Main/navigationSideBar.ts", Properties.Resources.navigationSideBar_ts);

            AddToBaseFolder("Http/AccountService.ts", Properties.Resources.AccountService_ts, true);
        }
        ...
        public void GenerateEnvironment()
        {
            ...
            AddToUI("declarations.d.ts", Properties.Resources.declarations_d);
            AddToUI("package.json", Properties.Resources.package_json);
            AddToUI("tsconfig.json", Properties.Resources.tsconfig_json);
            AddToUI("WebPackSharedConfig.js", Properties.Resources.WebPackSharedConfig_js);
            AddToUI("webpack.config.vendor.js", Properties.Resources.webpack_config_vendor_js);
            AddToUI("appsettings.development.json", Properties.Resources.appsettings_json);
