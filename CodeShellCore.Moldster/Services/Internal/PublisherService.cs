...
namespace CodeShellCore.Moldster.Services.Internal
{
    public class PublisherService : ConsoleService, IPublisherService
    {
        ...
        UploadConfig Config => envAccessor.CurrentEnvironment.Upload;
            ...
            IOutputWriter output) : base(output)
        {
            ...
            this.unit = unit;
            this.output = output;
            if (envAccessor.CurrentEnvironment.Upload == null)
            {
                envAccessor.CurrentEnvironment.Upload = new UploadConfig
                {
                    Type = "DEV"
                };
            }
