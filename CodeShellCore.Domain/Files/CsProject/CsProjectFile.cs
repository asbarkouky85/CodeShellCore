...
namespace CodeShellCore.Files.CsProject
{
    public class CsProjectFile
    {
        ...
        List<string> _projectReferences = new List<string>();
        ...
        public string[] ProjectReferences => _projectReferences.ToArray();
        ...
        public void ReadVersionParameters()
        {
            ...
            for (var i = 0; i < allLines.Count; i++)
            {
                var projectReference = GetTagContent(allLines[i], null, "ProjectReference Include=\"(.*)\"");
        ...
        protected virtual string GetTagContent(string subject, string tag, string usePattern = null)
        {
            ...
            return GetContent(subject, patternString);
        }

        protected virtual string GetContent(string subject, string patternString)
        {
