...
namespace CodeShellCore.Web.Razor.Tables.Moldster
{
    public interface IMoldsterTableHelper : IAngularTablesHelper
    {
        ...
        CellWriter HeaderCell<T, TValue>(IHtmlHelper<T> helper, Expression<Func<T, TValue>> exp, string width, bool ignoreAccessibility, object cellAttributes, bool sorting = true);
        CellWriter HeaderCell<T>(IHtmlHelper<T> helper, string textId, bool isColumn = false, string size = null, object cellAttributes = null, bool ignoreAccessibility = false, bool sorting = true);
