...
namespace CodeShellCore.Web.Razor.Tables.Moldster
{
    ...
    {
        CellWriter HeaderCell<T>(IHtmlHelper<T> helper, MoldsterHtmlContainer parent, string textId, bool isColumn = false, string size = null, object cellAttributes = null, bool ignoreAccessibility = false);
        ...
        CellWriter HeaderCell<T, TValue>(IHtmlHelper<T> helper, Expression<Func<T, TValue>> exp, MoldsterHtmlContainer parent, string width, bool ignoreAccessibility, object cellAttributes);
