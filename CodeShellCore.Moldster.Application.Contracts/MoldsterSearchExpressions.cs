...
{
    public static class MoldsterSearchExpressions
    {
        public static void RegisterExpressions()
        {
            ...
            ExpressionStore.RegisterSearchExpression<NavigationGroupLookupDto>(term => e => e.Name.Contains(term));

            ExpressionStore.RegisterSearchExpression<NavigationPageRouteDto>(term => e => e.Url.Contains(term));
