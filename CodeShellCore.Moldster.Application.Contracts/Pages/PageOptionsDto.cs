...
namespace CodeShellCore.Moldster.Pages
{
    public class PageOptionsDto
    {
        ...
        public Dictionary<string, ControlRenderDto> Controls { get; set; }
        ...
        public PageOptionsDto()
        {
            ...
            Controls = new Dictionary<string, ControlRenderDto>();
        }
        ...
        {
            if (!Controls.TryGetValue(name, out ControlRenderDto opts))
                return new Accessibility(0);

            return new Accessibility(opts.Accessibilty);
        }

        public void SetViewParams(ViewParams prms)
        {
            _viewParams = prms;
        }
    }
