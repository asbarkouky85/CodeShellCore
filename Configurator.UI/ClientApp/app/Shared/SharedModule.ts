...
import { ModuleConfigModal } from "../Domains/ModuleConfigModal";
import { ResourceEditModal } from "../Resources/ResourceEditModal";


@NgModule({
    declarations: [DomainTree,PageList,PageCategoryList,PageCategoryCreate,DomainTreeSelect,NaveList,NavigationPageList,NavigationPageCreate,GenerationInofList,PageCategorySelect,ResourceModal,ServerTracerModal,ModuleConfigModal,ResourceEditModal,],
    exports: [
		DomainTree,PageList,PageCategoryList,PageCategoryCreate,DomainTreeSelect,NaveList,NavigationPageList,NavigationPageCreate,GenerationInofList,PageCategorySelect,ResourceModal,ServerTracerModal,ModuleConfigModal,ResourceEditModal,
		ExampleBaseModule
	],
    imports: [
        ExampleBaseModule
    ],
	entryComponents:[DomainTree,PageList,PageCategoryList,PageCategoryCreate,DomainTreeSelect,NaveList,NavigationPageList,NavigationPageCreate,GenerationInofList,PageCategorySelect,ResourceModal,ServerTracerModal,ModuleConfigModal,ResourceEditModal,]
})
...
Registry.Register("Domains/ModuleConfigModal", ModuleConfigModal);
Registry.Register("Resources/ResourceEditModal", ResourceEditModal);
